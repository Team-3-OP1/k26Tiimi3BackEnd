...
public class AuthRestController {
    ...
    public AuthRestController(AppUserRepository userRepository, RoleRepository roleRepository,
            AsiakasRepository asiakasRepository, VarausRepository varausRepository, 
    ...
    public ResponseEntity<?> register(@RequestBody RegisterRequest req) {
        ...
        return ResponseEntity.status(HttpStatus.CREATED).body("User and customer profile created");
    }
    ...
    public ResponseEntity<?> deleteAccount(Authentication auth) {
        ...
        Asiakas asiakas = asiakasRepository.findByUsername(username)
                .orElseThrow(() -> new RuntimeException("Asiakasta ei löytynyt"));
        varausRepository.deleteByAsiakasId(asiakas.getId());
        asiakasRepository.delete(asiakas);
        userRepository.findByUsername(username).ifPresent(userRepository::delete);
        return ResponseEntity.ok("Tili poistettu onnistuneesti.");
    }

    public static class LoginRequest { public String username; public String password; }
    public static class RegisterRequest { public String username; public String password; public String firstName; public String lastName; public String email; }
